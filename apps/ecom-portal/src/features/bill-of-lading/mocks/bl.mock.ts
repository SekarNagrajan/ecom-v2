...
export const mockBLListSeed: BLListDTO[] = [
  ...
  // Booking-parity volume (~20 rows) — D / S / C / I spread; details via getMockBLDetail → buildDetailFromList
  listRow({
    blNo: "BL-998830",
    mcnNo: null,
  ...
  listRow({
    blNo: "BL-998831",
    mcnNo: null,
    bookingNo: "BKG-778911",
    siNo: null,
    status: "D",
    agencyRefNo: "AGY-4471",
    origin: "KRPUS - BUSAN",
  ...
  listRow({
    ...
    origin: "SGSIN - SINGAPORE",
    loadPort: "SGSIN - SINGAPORE",
    dischargePort: "AUFRE - FREMANTLE",
    delivery: "AUFRE - FREMANTLE",
    confirmedDate: null,
    createdDate: "2026-08-23T15:00:00Z",
    printStatus: "N",
    appVersion: "2",
    isLocked: false,
  }),
  listRow({
    blNo: "BL-998834",
    mcnNo: null,
    bookingNo: "BKG-778914",
    siNo: "SIN998294",
    status: "S",
    agencyRefNo: "AGY-4474",
    origin: "CNSHA - SHANGHAI",
    loadPort: "CNSHA - SHANGHAI",
    dischargePort: "DEHAM - HAMBURG",
    delivery: "DEHAM - HAMBURG",
    confirmedDate: null,
    createdDate: "2026-08-22T16:00:00Z",
    printStatus: "N",
    appVersion: "2",
    isLocked: false,
  }),
  listRow({
    blNo: "BL-998835",
    mcnNo: null,
    bookingNo: "BKG-778915",
    siNo: "SIN998295",
    status: "S",
    agencyRefNo: "AGY-4475",
    origin: "TWKHH - KAOHSIUNG",
    loadPort: "TWKHH - KAOHSIUNG",
    dischargePort: "SGSIN - SINGAPORE",
    delivery: "SGSIN - SINGAPORE",
    confirmedDate: null,
  ...
  listRow({
    blNo: "BL-998836",
    mcnNo: "MCN-2026-011",
    bookingNo: "BKG-778916",
    siNo: "SIN998296",
    status: "I",
    agencyRefNo: "AGY-4476",
    origin: "USLAX - LOS ANGELES",
    loadPort: "USLAX - LOS ANGELES",
    dischargePort: "JPOSA - OSAKA",
    delivery: "JPOSA - OSAKA",
    confirmedDate: "2026-08-18T10:00:00Z",
  ...
  listRow({
    blNo: "BL-998837",
    mcnNo: null,
    bookingNo: "BKG-778917",
    siNo: "SIN998297",
    status: "I",
    agencyRefNo: "AGY-4477",
    origin: "GBFEL - FELIXSTOWE",
    loadPort: "GBFEL - FELIXSTOWE",
    dischargePort: "USNYC - NEW YORK",
    delivery: "USNYC - NEW YORK",
    confirmedDate: "2026-08-16T11:00:00Z",
  ...
  listRow({
    blNo: "BL-998838",
    mcnNo: null,
    bookingNo: "BKG-778918",
    siNo: "SIN998298",
    status: "I",
    agencyRefNo: "AGY-4478",
    origin: "NLRTM - ROTTERDAM",
    loadPort: "NLRTM - ROTTERDAM",
    dischargePort: "INNSA - NHAVA SHEVA",
    delivery: "INNSA - NHAVA SHEVA",
    confirmedDate: "2026-08-14T12:00:00Z",
