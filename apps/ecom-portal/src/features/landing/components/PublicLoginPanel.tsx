...
import { EyeInvisibleOutlined, EyeTwoTone, LockOutlined, SafetyCertificateOutlined, UserOutlined } from '@ant-design/icons';
import { PRECONFIGURED_TENANTS } from '@solverminds/auth';
import { AppDrawer } from '@solverminds/shared-ui';
import { useNavigate } from '@tanstack/react-router';
import { Alert, Button, Checkbox, Divider, Flex, Input, Spin, Typography, theme } from 'antd';
