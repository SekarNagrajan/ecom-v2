...
const MOCK_TENANT_USERS: Record<string, LoginSuccessResponse> = {
  TENANT_01: {
    ...
    user: {
      ...
      role: 'CUSTOMER',
      capabilities: ['SCH', 'TRK', 'BKG', 'SI', 'BL', 'CRO', 'ARN', 'STMT', 'CO2', 'VGM', 'PAY'],
  ...
  TENANT_03: {
    ...
    user: {
      ...
      role: 'CUSTOMER',
      capabilities: ['SCH', 'TRK', 'BKG', 'SI', 'BL', 'CRO', 'ARN', 'STMT', 'CO2', 'PAY'],
  ...
  TENANT_04: {
    ...
    user: {
      ...
      role: 'CUSTOMER',
      capabilities: ['SCH', 'TRK', 'BKG', 'BL', 'CRO', 'ARN', 'STMT', 'CO2', 'VGM'],
  ...
  TENANT_06: {
    ...
    user: {
      ...
      role: 'CUSTOMER',
      capabilities: ['SCH', 'TRK', 'BKG', 'SI', 'BL', 'CRO', 'ARN', 'STMT', 'CO2', 'VGM'],
